...
<img src="https://komarev.com/ghpvc/?username=thaynabds&label=Visualizações%20do%20Perfil&color=6C3483&style=flat-square" />
...
![IA Generativa](https://img.shields.io/badge/IA_Generativa-412991?style=flat-square&logoColor=white)
...
![Visão Computacional](https://img.shields.io/badge/Visão_Computacional-0078D4?style=flat-square&logoColor=white)
![Engenharia de Prompt](https://img.shields.io/badge/Engenharia_de_Prompt-412991?style=flat-square&logoColor=white)
...
![Análise de Requisitos](https://img.shields.io/badge/Análise_de_Requisitos-F24E1E?style=flat-square&logoColor=white)
![Figma](https://img.shields.io/badge/Figma-F24E1E?style=flat-square&logo=figma&logoColor=white)
![Prototipagem de Alta Fidelidade](https://img.shields.io/badge/Prototipagem_de_Alta_Fidelidade-F24E1E?style=flat-square&logoColor=white)
...
![Pacote Office](https://img.shields.io/badge/Pacote_Office-D83B01?style=flat-square&logo=microsoftoffice&logoColor=white)
...
![Gestão de Projetos](https://img.shields.io/badge/Gestão_de_Projetos-6DB33F?style=flat-square&logoColor=white)
![Automação de Processos](https://img.shields.io/badge/Automação_de_Processos-EF6C00?style=flat-square&logoColor=white)
![Liderança de Equipe](https://img.shields.io/badge/Liderança_de_Equipe-6DB33F?style=flat-square&logoColor=white)
...
- Engenharia de Prompt com GitHub Copilot e OpenAI
- Fundamentos de IA no Azure: Visão Computacional, NLP, RAG, OCR
- Prototipagem de interfaces de alta fidelidade com Figma
- Estruturação de projetos Full-Stack e Full Cycle
- Product Design e Análise de Requisitos

## 🤝 Competências Comportamentais (Soft Skills)

- Raciocínio lógico-analítico e resolução de problemas
- Organização, autonomia e aprendizado contínuo
- Comunicação clara e trabalho em equipe
- Proatividade e gestão de tempo
- Metodologias ágeis — Scrum Master certificada pela DIO
...
`Figma` `UX/UI` `Análise de Requisitos` `Product Design` `Design & Prototipação` `PHP` `HTML + Bootstrap` `MySQL`

🔗 [Site/Deploy](https://grupotp.polyclub.com.br/) · [GitHub](https://github.com/GrupoTP/Sistema-de-Envio-e-Armazenamento-dos-Projetos-ADS) · [Figma](https://www.figma.com/make/XETVIneDIARTVrgXoidrN4/OBSERVAT%C3%93RIO-DE-PROJETOS-INTEGRADORES--SENAC-?fullscreen=1&t=vf5Kz8t2XzB1XtNc-1&code-node-id=0-10)
...
🔗 [Site/Deploy](https://asasabertas-aero-clube.vercel.app/) · [GitHub](https://github.com/thaynabds/AeroclubAsasAbertas/tree/main) · [Pitch](https://youtu.be/3jx62rMK60U)
...
`Python` `Whisper` `OpenAI API` `gTTS` `NLP` `IA Generativa`
...
`Python` `IA Generativa` `OpenAI API` `Engenharia de Prompt`
...
`Figma` `UX/UI` `Product Design` `Análise de Requisitos`
...
`Typebot` `Low-code` `Automação de Processos`
...
`IA Generativa` `JavaScript` `Lógica de Programação`
...
`JavaScript` `Lógica de Programação` `Front-End`
...
<table>
  <tr>
    <td align="center" width="180">
      <img src="https://flagcdn.com/w80/br.png" width="48" height="32" alt="Português"/><br/>
      <strong>Português</strong><br/>
      <img src="https://img.shields.io/badge/Nativo-2E7D32?style=flat-square&logoColor=white" />
    </td>
    <td align="center" width="180">
      <img src="https://flagcdn.com/w80/us.png" width="48" height="32" alt="Inglês"/><br/>
      <strong>Inglês</strong><br/>
      <img src="https://img.shields.io/badge/Avançado-1565C0?style=flat-square&logoColor=white" />
    </td>
    <td align="center" width="180">
      <img src="https://flagcdn.com/w80/es.png" width="48" height="32" alt="Espanhol"/><br/>
      <strong>Espanhol</strong><br/>
      <img src="https://img.shields.io/badge/Básico-6A1B9A?style=flat-square&logoColor=white" />
    </td>
  </tr>
</table>
</div>
...
📍 **Recife/PE, Brasil** &nbsp;|&nbsp; 📞 **+55 (81) 97912-6121** &nbsp;|&nbsp; 📧 **thaynabdstec@gmail.com**
